...
//		크롬, 파이어폭스 OS, 오페라
		$out->addMeta('theme-color', '#B20000');
//		윈도우 폰
		$out->addMeta('msapplication-navbutton-color', '#B20000'); 
//		트위터 카드 시작
		...
		$out->addMeta('apple-mobile-web-app-status-bar-style', '#B20000');
			  ...
			  <li id="right-search">
				...
				<li class="dropdown">
                   <a class="dropdown-toggle" data-close-others="false" data-delay="0" data-hover=
                      ...
                      <ul aria-labelledby="<?php echo $this->msg($theMsg); ?>" role="menu" class="dropdown-menu" <?php $this->html( 'userlangattributes' ); ?>>
			<li id="t-re"><?php echo '<a href="//www.facebook.com/BusConcertobuswiki">';?><i class="fa fa-external-link" aria-hidden="true"></i> 버스위키 페이스북</a></li>
			<li id="t-re"><?php echo '<a href="//kiwki.us">';?><i class="fa fa-user-plus" aria-hidden="true"></i> 키위위키</a></li>
						</ul>
				</li>
				<li class="dropdown">
                   <a class="dropdown-toggle" data-close-others="false" data-delay="0" data-hover=
